    ...
    static TypeId tid =
        TypeId("ns3::RandomWalk2dMobilityModel")
            ...
            .AddAttribute("Mode",
                          ...
                          EnumValue<Mode>(RandomWalk2dMobilityModel::MODE_DISTANCE),
                          MakeEnumAccessor<Mode>(&RandomWalk2dMobilityModel::m_mode),
