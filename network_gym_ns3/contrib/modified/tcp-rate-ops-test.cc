...
TcpRateLinuxWithBufferTest::TestWithSackBlocks()
{
    ...
    for (uint8_t i = 1; i <= 2; ++i)
    {
        ...
        m_rateOps->GenerateSample(false, m_segmentSize, 0, false, priorInFlight, Seconds(0));
    }
    ...
    TcpRateOps::TcpRateSample rateSample =
        m_rateOps->GenerateSample(false, 5 * m_segmentSize, 0, false, priorInFlight, Seconds(0));
}
