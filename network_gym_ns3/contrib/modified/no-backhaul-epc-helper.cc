      ...
      m_s5LinkMtu(3000)
{
    ...
    subnet2 << subNetId+13 << ".0.0.0";
    m_s11Ipv4AddressHelper.SetBase(subnet2.str ().c_str (), "255.255.255.252");

    subnet3 << subNetId+14 << ".0.0.0";
    m_s5Ipv4AddressHelper.SetBase(subnet3.str ().c_str (), "255.255.255.252");
